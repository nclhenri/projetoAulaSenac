            ...
            <?php foreach ($lista as $linha) : ?>
                <tr>
                    ...
                    <td class="ajusteImagem">
                        <img src="../img/<?php echo $linha['fotoExercicio'] ?>" alt="">
                    </td>
                    <td><?php echo $linha['linkExercicio'] ?></td>
                    <td>
                        <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=exercicios&e=atualizar&id=<?php echo $linha['idExercicio'] ?>">
                    ...
                    <td>
                        <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=exercicios&e=desativar">
