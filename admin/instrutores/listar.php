<?php
require_once('class/instrutores.php');
$instrutores = new InstrutoresClass();
$lista = $instrutores->ListarInstrutores();
?>
...
<div class="table-resposive">
    <table class="table table-bordered border-primary">
        <caption>Lista Instrutores</caption>
        <thead>
            <tr>
                <th>Nome</th>
        ...
        <tbody>
            <?php foreach ($lista as $linha) : ?>
                <tr>
                    ...
                    <td><?php echo $linha['especialidadeFuncionario'] ?></td>
                    ...
                    <td class="ajusteImagem">
                        <img src="../img/<?php echo $linha['fotoFuncionario'] ?>" alt=""></td>
                    <td>
                        <div>
                            <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="#">
