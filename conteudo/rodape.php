    ...
    <section>
        <div class="site">
            ...
            <div class="infoAcademia">
                ...
                <ul>
                    <li><a href=""><img src="./img/iconFaceRodape.png" alt="Rede Social da Academia"></a></li>
                    <li><a href=""><img src="./img/iconInstaRodape.png" alt="Rede Social da Academia"></a></li>
                    <li><a href=""><img src="./img/iconWhatsRodape.png" alt="Rede Social da Academia"></a></li>
                </ul>
                <a href="mailto:vivabem@ti21.smpsistema.com.br">vivabem@ti21.smpsistema.com.br</a>
                <a href="tel:+5511999999999">(11) 9999-999</a>
...
<div id="loginModal" class="modal">
    <div class="modal-content">
        <span class="close" id="cloose" onclick="closeModal()">&times;</span>
        <h2>Login</h2>
        <form id="loginForm">
